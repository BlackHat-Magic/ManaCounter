(function () {
    try {
        ...
        var savedMode = ls.getItem("theme.mode");
        var pref = null;
        try {
...
window.parallaxPage = function (opts = {}) {
